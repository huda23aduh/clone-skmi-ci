            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-light py-3">
                    <h5 class="card-title mb-0 d-flex align-items-center">
                        <i class="fas fa-code me-2"></i>Code Preview
                    </h5>
                </div>
                <div class="card-body p-0">
                    <div class="code-container" style="max-height: 70vh; overflow: auto;">
                        <pre class="p-3 mb-0" style="background: #f6f8fa; margin: 0;"><code class="language-<?= $language ?>"><?= $content ?></code></pre>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="form-control bg-light"><?= strtoupper($fileExtension) ?> (<?= $language ?> code)</p>
                    </div>
